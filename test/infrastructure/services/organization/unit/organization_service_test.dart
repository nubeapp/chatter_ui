...
import 'package:ui/domain/services/organization_service_interface.dart';
import 'package:ui/infrastructure/services/organization_service.dart';
...
void main() {
  ...
  const String API_BASE_URL = 'http://0.0.0.0:8000/organizations';
